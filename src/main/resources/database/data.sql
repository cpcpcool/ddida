...
('user3', '노윤건', '결제 문의', '결제 관련 문의 내용입니다.', '2024-01-08 14:45:00', 20, 1),
('user1', '박재용', '이용 후기 공유', '체육시설 이용 후기입니다.', '2024-01-12 19:00:00', 25, 0);

insert into qna(username, name, title, description, qna_date, qna_view, qna_secret, answer, answer_time)
values
('user1', '박재용', '결제 금액이 안보여요', '얼마를 결제해야하나요..?', '2024-02-05', 24, 1, 'api 금액필드가 비어있어 별도 연락이 필요합니다', '2024-02-06');
...
(2, 'CF02P0645947', '대체육관', '2024-02-05', '2024-02-02', '14:30:02', '개별 문의', '업체 문의', '010-1234-5678', 'kmmnnnh@gmail.com', '김민혜', '갈 때 마다 깨끗해서 좋네요', 0),
(2, 'EH22N4422987', '테니스장(양평누리체육공원)', '2024-02-03', '2024-02-01', '12:40:16', '개별 문의', '업체 문의', '010-1234-5678', 'kmmnnnh@gmail.com', '김민혜',  '두 번째 이용입니다', 0);
...
(1, 'EH22N4422987', '테니스장(양평누리체육공원)', '2024-02-25', '2024-02-02', '12:40:16', '개별 문의', '업체 문의', '010-1234-5678', 'cpcpcoole@gmail.com', '박재용', 0),
(3, 'CF02P0645947', '대체육관', '2024-02-11', '2024-02-02', '12:40:16', '개별 문의', '업체 문의', '010-1234-5678', 'nyg-6789@gmail.com', '노윤건', 0),
(3, 'EH22N4422987', '테니스장(양평누리체육공원)', '2024-02-25', '2024-02-02', '12:40:16', '개별 문의', '업체 문의', '010-1234-5678', 'nyg-6789@gmail.com', '노윤건', 0);
...
values
('user2', '김민혜', '체육시설 이용 문의', '체육시설 이용 관련 문의 내용입니다.', '2024-02-05 10:30:00', 15, 0),
('user3', '노윤건', '결제 문의', '결제 관련 문의 내용입니다.', '2024-02-08 14:45:00', 20, 1),
('user1', '박재용', '현장에 가서 직접 결제하고 싶으면', '가서 직접 결제하고 싶으면 전화로 문의해야 하나요', '2024-02-12 19:00:00', 25, 0);

insert into qna(username, name, title, description, qna_date, qna_view, qna_secret, answer, answer_time)
values
('user1', '박재용', '결제 금액이 안보여요', '얼마를 결제해야하나요..?', '2024-02-18', 24, 1, 'api 금액필드가 비어있어 별도 연락이 필요합니다', '2024-02-06');